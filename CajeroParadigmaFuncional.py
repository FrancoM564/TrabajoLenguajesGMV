...
def retiro(file, lista):
    ...
    tiempoEscribir= None
    if lista[1] == "debito":
        inicioe=default_timer()
        ret = int(input("Cuanto desea retirar de su saldo?: "))
        tiempoEscribir=default_timer() - inicioe
        if ret > int(lista[3]):
    ...
    tiempo = default_timer() - tiempoEscribir - inicio
    print("Tiempo de ejecución de la operación retiro sin tomar en cuenta la escritura del usuario: ",tiempo)
...
def deposito(file, lista):
    ...
    sobreescribir(file,lista)  
    tiempo = default_timer() - tiempoEscribir - inicio
    print("Tiempo de ejecución de la operación depósito sin tomar en cuenta la escritura del usuario: ",tiempo)
...
def consultas(lista):
    ...
    finr=default_timer() - inicio
    print("Tiempo de ejecución de la operación consulta: ",finr)
